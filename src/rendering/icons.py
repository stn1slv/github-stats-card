"""SVG icon definitions for GitHub stats."""
...
ICONS: dict[str, str] = {
    ...
    "repos": """<path fill-rule="evenodd" d="M8 1.5c-2.761 0-5 .895-5 2v9c0 1.105 2.239 2 5 2s5-.895 5-2v-9c0-1.105-2.239-2-5-2zm0 1c2.485 0 3.5.61 3.5 1S10.485 4.5 8 4.5 4.5 3.89 4.5 3.5 5.515 2.5 8 2.5zm-3.5 2.34c.97.43 2.18.66 3.5.66s2.53-.23 3.5-.66V7c0 .39-1.015 1-3.5 1s-3.5-.61-3.5-1V4.84zm0 3.5c.97.43 2.18.66 3.5.66s2.53-.23 3.5-.66v2.16c0 .39-1.015 1-3.5 1s-3.5-.61-3.5-1V8.34zm0 3.5c.97.43 2.18.66 3.5.66s2.53-.23 3.5-.66v.66c0 .39-1.015 1-3.5 1s-3.5-.61-3.5-1v-.66z"/>""",
    ...
    "github": """<path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>""",
}
...
def get_icon_svg(name: str) -> str:
    ...
    The icon takes its fill from the ``.icon`` CSS rule emitted by
    ``rendering.base.render_card``, which is why this function takes no color:
    a presentation attribute on the element would lose to that rule anyway.

    Args:
        name: Icon name (star, commits, prs, issues, etc.)

    Returns:
        SVG icon element, or an empty string when the name is unknown
    """
